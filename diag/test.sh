...
ffmpeg -i cb1sampleiTunes4.mov -y -acodec libfaac -ab 96k -ar 44100 -ac 1 -vcodec libx264 -vpre normal -crf 28 -threads 0 -s 704x480 results/04outtmp.mp4

qt-faststart results/04outtmp.mp4 results/05qtout.mp4

ffmpeg -ss 2 -deinterlace -i cb1sampleiTunes4.mov  -y -vframes 1 -f mjpeg results/06ffmpegout.jpg
