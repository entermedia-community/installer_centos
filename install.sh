...
wget http://pkgs.org/centos-6-rhel-6/rpmfusion-free-updates-testing-x86_64/gpac-doc-0.5.0-1.el6.x86_64.rpm
...
rpm -i --nosignature gtkimageview-1.6.3-1.el6.rf.x86_64.rpmº
yum update
yum install gpac
...
yum install ffmpeg
cp apache-tomcat /etc/init.d/tomcat
mkdir /opt/apache-tomcat/sites
unzip ROOT.war /opt/apache-tomcat/sites
