...
yum install java-1.6.0-openjdk gpac gtkimageview lame x264  perl-Image-ExifTool libreoffice-headless ffmpeg

yum install rpms/ufraw*
yum install rpms/ImageMagick*
